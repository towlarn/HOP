 ...
 *
 * To run: bin/hadoop jar build/hadoop-examples.jar wordcountstream
 *            [-s] [-m <i>maps</i>] [-r <i>reduces</i>] <i>in-dir</i> <i>out-dir</i> 
 */
public class WordCountStream extends Configured implements Tool {
  ...
  static int printUsage() {
    System.out.println("wordcountstream [-s interval] [-S <sort>] [-p <pipeline>] [-m maps] [-r reduces] input output");
  ...
  public int run(String[] args) throws Exception {
    JobConf conf = new JobConf(getConf(), WordCountStream.class);
    conf.setJobName("wordcountstream");
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new WordCountStream(), args);
    System.exit(res);
  }
